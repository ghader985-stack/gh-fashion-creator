            ...
            <div onClick={function() { setStarted(true); }} style={{ padding: '16px', background: 'white', borderRadius: '16px', cursor: 'pointer', border: '2px solid rgba(201,160,120,0.2)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div style={{ textAlign: 'right' }}>
                  <h3 style={{ color: '#C9A078', marginBottom: '4px' }}>Basic</h3>
                  <p style={{ color: '#8D7D6D', fontSize: '0.8rem' }}>100 images - 200 prompts</p>
                </div>
                <span style={{ color: '#C9A078', fontWeight: '700', fontSize: '1.3rem' }}>$15</span>
              </div>
            </div>
            <div onClick={function() { setStarted(true); }} style={{ padding: '16px', background: 'white', borderRadius: '16px', cursor: 'pointer', border: '2px solid rgba(201,160,120,0.2)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div style={{ textAlign: 'right' }}>
                  <h3 style={{ color: '#C9A078', marginBottom: '4px' }}>Pro</h3>
                  <p style={{ color: '#8D7D6D', fontSize: '0.8rem' }}>250 images - 500 prompts</p>
                </div>
                <span style={{ color: '#C9A078', fontWeight: '700', fontSize: '1.3rem' }}>$35</span>
              </div>
            </div>
            <div onClick={function() { setStarted(true); }} style={{ padding: '16px', background: 'white', borderRadius: '16px', cursor: 'pointer', border: '2px solid rgba(201,160,120,0.2)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div style={{ textAlign: 'right' }}>
                  <h3 style={{ color: '#C9A078', marginBottom: '4px' }}>Unlimited</h3>
                  <p style={{ color: '#8D7D6D', fontSize: '0.8rem' }}>600 images - 1200 prompts</p>
                </div>
                <span style={{ color: '#C9A078', fontWeight: '700', fontSize: '1.3rem' }}>$75</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div style={{ maxWidth: '600px', margin: '0 auto' }}>
        ...
        <div style={{ background: 'white', borderRadius: '20px', padding: '18px', boxShadow: '0 4px 20px rgba(201,160,120,0.1)' }}>
          {(tab === 'design' || tab === 'video' || tab === 'generate') && (
            <div style={{ marginBottom: '14px' }}>
              ...
              <div style={{ display: 'flex', gap: '8px', justifyContent: 'center' }}>
                <button onClick={function() { setRatio('1:1'); }} style={{ padding: '8px 18px', borderRadius: '12px', cursor: 'pointer', border: ratio === '1:1' ? 'none' : '1px solid rgba(201,160,120,0.3)', background: ratio === '1:1' ? '#C9A078' : 'white', color: ratio === '1:1' ? '#fff' : '#9D8B7A', fontWeight: '500' }}>1:1</button>
                <button onClick={function() { setRatio('9:16'); }} style={{ padding: '8px 18px', borderRadius: '12px', cursor: 'pointer', border: ratio === '9:16' ? 'none' : '1px solid rgba(201,160,120,0.3)', background: ratio === '9:16' ? '#C9A078' : 'white', color: ratio === '9:16' ? '#fff' : '#9D8B7A', fontWeight: '500' }}>9:16</button>
                <button onClick={function() { setRatio('16:9'); }} style={{ padding: '8px 18px', borderRadius: '12px', cursor: 'pointer', border: ratio === '16:9' ? 'none' : '1px solid rgba(201,160,120,0.3)', background: ratio === '16:9' ? '#C9A078' : 'white', color: ratio === '16:9' ? '#fff' : '#9D8B7A', fontWeight: '500' }}>16:9</button>
              </div>
            </div>
          )}
          {(tab === 'design' || tab === 'video' || tab === 'generate') && (
            <div style={{ marginBottom: '14px' }}>
              ...
              <div style={{ display: 'flex', gap: '8px', justifyContent: 'center' }}>
                <button onClick={function() { setPromptLength('short'); }} style={{ padding: '8px 16px', borderRadius: '12px', cursor: 'pointer', border: promptLength === 'short' ? 'none' : '1px solid rgba(201,160,120,0.3)', background: promptLength === 'short' ? '#C9A078' : 'white', color: promptLength === 'short' ? '#fff' : '#9D8B7A', fontWeight: '500', fontSize: '0.85rem' }}>Short</button>
                <button onClick={function() { setPromptLength('medium'); }} style={{ padding: '8px 16px', borderRadius: '12px', cursor: 'pointer', border: promptLength === 'medium' ? 'none' : '1px solid rgba(201,160,120,0.3)', background: promptLength === 'medium' ? '#C9A078' : 'white', color: promptLength === 'medium' ? '#fff' : '#9D8B7A', fontWeight: '500', fontSize: '0.85rem' }}>Medium</button>
                <button onClick={function() { setPromptLength('pro'); }} style={{ padding: '8px 16px', borderRadius: '12px', cursor: 'pointer', border: promptLength === 'pro' ? 'none' : '1px solid rgba(201,160,120,0.3)', background: promptLength === 'pro' ? '#C9A078' : 'white', color: promptLength === 'pro' ? '#fff' : '#9D8B7A', fontWeight: '500', fontSize: '0.85rem' }}>Pro</button>
              </div>
            </div>
          )}
          {tab === 'marketing' && (
            <div style={{ marginBottom: '14px' }}>
              ...
              <div style={{ display: 'flex', gap: '6px', justifyContent: 'center', flexWrap: 'wrap' }}>
                <button onClick={function() { setPlatform('reel'); }} style={{ padding: '7px 12px', borderRadius: '12px', cursor: 'pointer', border: platform === 'reel' ? 'none' : '1px solid rgba(201,160,120,0.3)', background: platform === 'reel' ? '#C9A078' : 'white', color: platform === 'reel' ? '#fff' : '#9D8B7A', fontSize: '0.8rem' }}>Reel</button>
                <button onClick={function() { setPlatform('tiktok'); }} style={{ padding: '7px 12px', borderRadius: '12px', cursor: 'pointer', border: platform === 'tiktok' ? 'none' : '1px solid rgba(201,160,120,0.3)', background: platform === 'tiktok' ? '#C9A078' : 'white', color: platform === 'tiktok' ? '#fff' : '#9D8B7A', fontSize: '0.8rem' }}>TikTok</button>
                <button onClick={function() { setPlatform('story'); }} style={{ padding: '7px 12px', borderRadius: '12px', cursor: 'pointer', border: platform === 'story' ? 'none' : '1px solid rgba(201,160,120,0.3)', background: platform === 'story' ? '#C9A078' : 'white', color: platform === 'story' ? '#fff' : '#9D8B7A', fontSize: '0.8rem' }}>Story</button>
                <button onClick={function() { setPlatform('post'); }} style={{ padding: '7px 12px', borderRadius: '12px', cursor: 'pointer', border: platform === 'post' ? 'none' : '1px solid rgba(201,160,120,0.3)', background: platform === 'post' ? '#C9A078' : 'white', color: platform === 'post' ? '#fff' : '#9D8B7A', fontSize: '0.8rem' }}>Post</button>
              </div>
            </div>
          )}
          <div style={{ marginBottom: '14px' }}>
          ...
          <div style={{ marginBottom: '14px' }}>
            ...
            <textarea value={input} onChange={function(e) { setInput(e.target.value); }} placeholder="Example: Golden evening dress with handmade embroidery..." style={{ width: '100%', padding: '12px', borderRadius: '12px', fontSize: '0.9rem', border: '1px solid rgba(201,160,120,0.3)', background: '#FDFAF7', outline: 'none', minHeight: '80px', resize: 'vertical', fontFamily: 'inherit', boxSizing: 'border-box' }} />
          </div>
          {tab === 'generate' ? (
          ...
          {generatedImg && (
            <div style={{ marginTop: '16px', textAlign: 'center' }}>
              ...
              <a href={generatedImg} download="gh-fashion.png" style={{ display: 'inline-block', padding: '10px 20px', background: '#C9A078', color: '#fff', borderRadius: '10px', textDecoration: 'none', fontSize: '0.9rem' }}>Download Image</a>
            </div>
          )}
          {output && (
            <div style={{ marginTop: '16px', padding: '14px', background: '#FDFAF7', borderRadius: '14px', border: '1px solid rgba(201,160,120,0.15)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
                <span style={{ color: '#C9A078', fontSize: '0.9rem', fontWeight: '600' }}>Result</span>
                <button onClick={copy} style={{ padding: '6px 14px', background: copied ? '#7CB07C' : '#C9A078', border: 'none', borderRadius: '8px', cursor: 'pointer', fontSize: '0.8rem', color: '#fff' }}>{copied ? 'Copied!' : 'Copy'}</button>
              </div>
        ...
        <footer style={{ textAlign: 'center', marginTop: '16px', color: '#B8A090', fontSize: '0.75rem' }}>Made with love by <span style={{ color: '#C9A078' }}>GH Fashion</span></footer>
      </div>
    </div>
  );
}
